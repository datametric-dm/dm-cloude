...
curl -X POST https://agencysuite.preview.emergentagent.com/api/tasks/trigger \
...
# Проверить статус
curl -X GET https://agencysuite.preview.emergentagent.com/api/tasks/status/{task_id} \
  -H "Authorization: Bearer token"
```
